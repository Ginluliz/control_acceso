...
if($_POST){
    ...
    `vistainge` (`idvistainge`,  `pinestatus`, `estatus`, `torniquete`, `rol`, `carrera`, `centro`, `nombre`, `apellidop`, `apellidom`) 
    VALUES (NULL, :pinestatus, :estatus, :torniquete, :rol, :carrera, :centro, :nombre, :apellidop, :apellidom)");
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a name="" id="" class="btn btn-primary" href="centroinge.php" role="button">Cancelar</a>
