...
if($_POST){
    ...
    `usuario` (`idusuario`, `nombre`, `apellidop`, `apellidom`, `matricula`, `pin`, `rol`, `estatus`, `carreras`, `centros`, `pinestatus`, `contrasena`, `fechainicio`) 
    VALUES (NULL, :nombre, :apellidop, :apellidom, :matricula, :pin, :rol, :estatus, :carreras, :centros, :pinestatus, :contrasena, :fechainicio)");
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control" name="fechainicio" id="fechainicio" placeholder="fechainicio">
        </div>


        <button type="submit" class="btn btn-success">Agregar Regristro</button>
