<?php
require "vistaplantilla.php";
require "db.php";


$txtID=(isset($_GET['txtID']))?$_GET['txtID']:"";
$lec = "SELECT `idvista`,  `fechahora`,`pinestatus`, `estatus`, `torniquete`, `rol`, `carrera`, `centro`, `nombre`, `apellidop`, `apellidom`
FROM vista WHERE rol=1";
...
while($row = $resuelto->fetch_assoc()){
    $pdf->Cell(20, 5, $row["idvista"], 1, 0, "L");
