...
if(isset( $_GET['txtID'])){
    ...
    $sentencia=$conexion->prepare("SELECT * FROM vistainge WHERE idvistainge=:idvistainge");
...
if($_POST){
    ...
    $sentencia=$conexion->prepare("UPDATE vistainge 
    SET
