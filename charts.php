...
<br/>
    ...
    <script type="text/javascript">
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Fecha Hora', 'Estatus', 'Torniquete', 'Rol', 'Carrera', 'Centro', 'Entradas/Salidas'],
          <?php 
          $query="SELECT * FROM vista";
          $res=mysqli_query($conectar, $query);
          while($data=mysqli_fetch_array($res)){
            ...
            $estatus=$data['estatus'];
            $torniquete=$data['torniquete'];
            $rol=$data['rol'];
            $carrera=$data['carrera'];
            $pinestatus=$data['centro'];
            $centro=$data['pinestatus'];
    ...
    <div id="chart" style="width: 900px; height: 500px;"></div>
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    <div class="card-header"><i class="fas fa-chart-pie mr-1"></i>Entradas y salidas</div>
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          while($resultado = mysqli_fetch_assoc($consulta)){
            echo "['".$resultado['fechahora']."',".$resultado['pinestatus']."],";
          }
          ?>
        ]);
